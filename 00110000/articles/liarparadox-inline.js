(function () {
    ...
    var slides = Array.from({ length: slideCount }, function (_, index) {
        return 'images/slideshow/liar/liar_slide_' + String(index + 1).padStart(2, '0') + '-desktop.jpg';
    });
    ...
    var showSlide = function (index) {
        ...
        image.alt = 'Liar Paradox slide ' + (currentSlide + 1) + ' of ' + slideCount;
    ...
    if ('IntersectionObserver' in window) {
        ...
        var checkDeckPosition = function () {
            ...
            var aboveFar = Math.sign(rect.top - window.innerHeight - 900) !== -1;
            var belowFar = Math.sign(rect.bottom + 900) !== 1;
